...
class ModuleOptions extends AbstractOptions implements AuthnetControllerOptionsInterface {
     ...
     * @login Username: nachtiy1919 password: P@ssw0rd
     */
    protected $sandboxApiLoginId = '9pT5guGY4e';
    protected $sandboxTransactionKey = '294QFddE8m4n5X66';    
    protected $sandboxApiUrl = '/student_enrollment/public/transaction/authnet/request';
     ...
     */
    protected $liveApiLoginId = '';
    protected $liveTransactionKey = '';
    protected $liveApiUrl = '';
    protected $liveApiMd5 = '';
     ...
     * @var array
     */
    protected $authIdentityFields = array('email', 'username', 'nsheid');
     ...
     * @var string
     */
    protected $userLoginWidgetViewTemplate = 'zfc-user/user/login-form.phtml';
     ...
     * @return string
     */
    public function getApiMd5Settings($enviro = NULL) {
        if ($enviro == 'sandbox'):
            return $this->sandboxApiMd5;
        elseif ($enviro == 'live'):
            return $this->liveApiMd5;
        endif;
    }
    /**
     * get login API URL
     ...
     * @return string
     */
    public function getApiUrl($enviro = NULL) {
        if ($enviro == 'sandbox'):
     ...
     * @return string
     */
    public function getApiLoginId($enviro = NULL) {
        if ($enviro == 'sandbox'):
            return $this->sandboxApiLoginId;
        elseif ($enviro == 'live'):
            return $this->liveApiLoginId;
        endif;
    }
    /**
     * get login API ID
     ...
     * @return string
     */
    public function getApiTransactionKey($enviro = NULL) {
        if ($enviro == 'sandbox'):
