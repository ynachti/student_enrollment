 ...
 */
//These settings can be configured in a database in the future
//keep that in mind when all is working 
//Also the identity options can be added to include email, username, employee id, nshe id, or bypass the login  
...
$settings = array(
     ...
     */
    'user_login_widget_view_template' => 'zfc-user/user/login-form.phtml',
    /**
